...
def initiate_analysis(thread_id: str = "initialanalysis"):
    global app
    if app is None:
        build_graph()
    ...
    try:
        ...
        if "interrupt" in str(e).lower():
            print("Human input required - analysis paused")
        else:
            raise e

def continue_with_human_input(thread_id: str, human_input: str):
